def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_torque = -0.1 * torch.square(pole_vel)  # Novel component: penalize pole torque
    rew_cart_angle = -0.05 * torch.square(torch.sin(cart_pos))  # Novel component: penalize cart angle
    rewards = {
        "alive": rew_alive,
