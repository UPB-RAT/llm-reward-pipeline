def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = rew_scale_pole_pos * torch.abs(pole_pos)  # Novel component: penalize pole angle
    rew_cart_pos = rew_scale_cart_vel * torch.square(cart_pos)  # Novel component: penalize cart position
    rewards = {
        "alive": rew_alive,
