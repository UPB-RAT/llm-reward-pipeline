def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_pole_pos * torch.abs(pole_pos)
    rew_cart_angle_smooth = rew_scale_pole_pos * torch.exp(-torch.abs(pole_pos))
    rewards = {
        "alive": rew_alive,
        ...
        "cart_angle_smooth": rew_cart_angle_smooth,
    }
