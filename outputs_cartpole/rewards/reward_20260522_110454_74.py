def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_pos = rew_scale_cart_vel * torch.abs(cart_pos)  # Novel component
    rew_angle_stability = rew_scale_pole_vel * torch.exp(-torch.abs(pole_vel))  # Novel component
    rewards = {
        "alive": rew_alive,
        ...
        "angle_stability": rew_angle_stability,
    }
