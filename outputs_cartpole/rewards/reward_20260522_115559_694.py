def _get_rewards(self) -> torch.Tensor:
    ...
    rew_angle_balance = rew_scale_pole_pos * torch.exp(-torch.abs(pole_pos))
    rew_cart_stability = rew_scale_cart_vel * torch.exp(-torch.abs(cart_vel))
    ...
    rewards = {
        ...
        "angle_balance": rew_angle_balance,
