def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_cart_pos * (1.0 - torch.abs(cart_pos) / self.cfg.max_cart_pos)
    rew_pole_torque = rew_scale_pole_torque * torch.abs(self.cartpole.get_joint_torque(self._pole_dof_idx[0]))
    rewards = {
        "alive": rew_alive,
        ...
        "cart_angle": rew_cart_angle,
        "pole_torque": rew_pole_torque,
    }
