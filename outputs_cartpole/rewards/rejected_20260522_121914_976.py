def _get_rewards(self) -> torch.Tensor:
    ...
    rew_balance = torch.exp(-torch.abs(pole_angle)) * rew_scale_pole_pos
    rew_cart_stability = torch.exp(-torch.square(cart_pos)) * rew_scale_cart_pos
    rewards = {
        "alive": rew_alive,
