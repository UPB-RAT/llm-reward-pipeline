def _get_rewards(self) -> torch.Tensor:
    ...
    rew_balance = rew_scale_pole_pos * (1.0 - torch.abs(pole_pos) / math.pi)
    rew_smooth_cart = rew_scale_cart_vel * torch.exp(-torch.square(cart_vel))
    rewards = {
        "alive": rew_alive,
