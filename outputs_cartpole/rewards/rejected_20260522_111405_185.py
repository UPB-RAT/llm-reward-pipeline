def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = rew_scale_pole_pos * torch.cos(pole_pos)  # Novel component
    rew_cart_accel = rew_scale_cart_vel * torch.abs(self.joint_acc[:, self._cart_dof_idx[0]])  # Novel component
    rewards = {
        "alive": rew_alive,
