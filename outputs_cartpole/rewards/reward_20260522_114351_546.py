def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_pole_pos * torch.square(torch.atan(pole_pos / cart_pos))
    rew_cart_smoothness = rew_scale_cart_vel * torch.exp(-torch.abs(cart_vel) / self.step_dt)
    rewards = {
        "alive": rew_alive,
        ...
        "cart_smoothness": rew_cart_smoothness,
    }
