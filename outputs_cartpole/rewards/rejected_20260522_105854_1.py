def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = -torch.abs(pole_pos / math.pi)  # Novel component: penalize pole angle
    rew_cart_pos = -torch.abs(cart_pos / self.cfg.max_cart_pos)  # Novel component: penalize cart position
    rewards = {
        "alive": rew_alive,
