def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_pole_pos * torch.square(self.joint_pos[:, self._pole_dof_idx[1]])
    rew_cart_angle_vel = rew_scale_pole_vel * torch.abs(self.joint_vel[:, self._pole_dof_idx[1]])
    ...
    rewards = {
        ...
        "cart_angle_vel": rew_cart_angle_vel,
    }
