def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_pos = -torch.abs(cart_pos)  # Novel component: penalize cart position deviation
    rew_angle = -torch.exp(-torch.abs(pole_pos))  # Novel component: reward for reducing pole angle deviation
    rewards = {
        "alive": rew_alive,
