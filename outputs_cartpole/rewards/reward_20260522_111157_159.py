def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_pole_pos * torch.abs(pole_pos)  # Novel component
    rew_pole_length = rew_scale_pole_pos * torch.abs(pole_pos)  # Novel component
    rewards = {
        "alive": rew_alive,
