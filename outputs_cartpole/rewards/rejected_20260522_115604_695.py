def _get_rewards(self) -> torch.Tensor:
    ...
    rew_angle_diff = torch.abs(pole_pos - math.pi)  # Novel component: Angle difference from vertical
    rew_velocity_diff = torch.abs(cart_vel - 0.0)  # Novel component: Velocity difference from zero
    rewards = {
        "alive": rew_alive,
        ...
        "velocity_diff": rew_velocity_diff,
    }
