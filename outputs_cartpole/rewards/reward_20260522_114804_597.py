def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = -torch.cos(pole_pos)  # Novel component: penalize pole from being upright
    rew_cart_pos = -torch.abs(cart_pos)  # Novel component: penalize cart from being centered
    rewards = {
        "alive": rew_alive,
