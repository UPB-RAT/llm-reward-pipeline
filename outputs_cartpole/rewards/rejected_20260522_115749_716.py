def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_acc = rew_scale_pole_vel * torch.abs(self.joint_acc[:, self._pole_dof_idx[0]])
    rew_cart_jerk = rew_scale_cart_vel * torch.abs(self.joint_jerk[:, self._cart_dof_idx[0]])
    rewards = {
        "alive": rew_alive,
