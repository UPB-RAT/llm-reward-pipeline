def _get_rewards(self) -> torch.Tensor:
    ...
    rew_angle_diff = rew_scale_pole_pos * torch.square(torch.abs(pole_pos) - math.pi / 2)
    rew_vel_diff = rew_scale_cart_vel * torch.abs(cart_vel - 0.0)
