def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_torque = -0.1 * torch.square(pole_vel)  # Novel: Penalize pole torque
    rew_cart_dist = -0.05 * torch.abs(cart_pos)  # Novel: Penalize cart displacement from center
    rewards = {
        "alive": rew_alive,
