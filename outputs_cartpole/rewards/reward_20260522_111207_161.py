def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = rew_scale_pole_pos * torch.square(torch.atan2(pole_pos, cart_pos))
    rew_cart_accel = rew_scale_cart_vel * torch.abs((self.joint_vel[:, self._cart_dof_idx[0]] - cart_vel) / self.step_dt)
    rewards = {
        "alive": rew_alive,
