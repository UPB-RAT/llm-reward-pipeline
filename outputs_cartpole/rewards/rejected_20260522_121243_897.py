def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_pos = rew_scale_cart_pos * torch.abs(cart_pos)  # Novel reward component
    rew_pole_angle = rew_scale_pole_angle * (torch.pi / 2 - torch.abs(pole_pos))  # Novel reward component
    ...
    rewards = {
        ...
        "cart_pos": rew_cart_pos,  # Added novel reward component
        "pole_angle": rew_pole_angle,  # Added novel reward component
    }
