def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = rew_scale_pole_vel * torch.abs(torch.atan2(pole_pos, cart_pos))
    rew_cart_accel = rew_scale_cart_vel * torch.abs(self.joint_acc[:, self._cart_dof_idx[0]])
