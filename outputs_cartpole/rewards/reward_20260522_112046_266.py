def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_pole_pos * torch.exp(-torch.abs(pole_pos))
    rew_pole_stability = rew_scale_pole_vel * torch.exp(-torch.square(pole_vel))
    rewards = {
        "alive": rew_alive,
        ...
        "pole_stability": rew_pole_stability,
    }
