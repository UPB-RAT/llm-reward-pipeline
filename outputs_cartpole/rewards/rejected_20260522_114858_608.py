def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = rew_scale_pole_pos * torch.clamp(pole_pos, -math.pi / 2, math.pi / 2)
    rew_cart_position = rew_scale_cart_vel * torch.clamp(cart_pos, -self.cfg.max_cart_pos, self.cfg.max_cart_pos)
    rewards = {
        "alive": rew_alive,
