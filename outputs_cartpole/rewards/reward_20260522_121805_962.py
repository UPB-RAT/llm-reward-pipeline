def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_pole_pos * torch.square(pole_pos + 1.5708)
    rew_cart_speed = rew_scale_cart_vel * torch.sqrt(torch.square(cart_vel) + 0.01)
    rewards = {
        "alive": rew_alive,
