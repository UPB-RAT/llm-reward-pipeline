def _get_rewards(self) -> torch.Tensor:
    ...
    rew_angle_cos = -torch.cos(pole_pos)  # Novel: Reward based on cosine of pole angle
    rew_cart_pos = -torch.abs(cart_pos)  # Novel: Penalize cart position deviation from center
    rewards = {
        "alive": rew_alive,
