def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = -0.5 * torch.square(pole_pos)  # Novel component: penalize large angles
    rew_cart_pos = -0.1 * torch.abs(cart_pos)  # Novel component: penalize large cart positions
    rewards = {
        "alive": rew_alive,
