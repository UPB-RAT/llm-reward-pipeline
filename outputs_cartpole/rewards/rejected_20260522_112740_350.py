def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = -torch.cos(pole_pos)  # Novel component: penalize pole angle from upright
    rew_cart_accel = -torch.abs(self.joint_acc[:, self._cart_dof_idx[0]])  # Novel component: penalize cart acceleration
    rewards = {
        "alive": rew_alive,
