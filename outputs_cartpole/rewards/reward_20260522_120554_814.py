def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = -0.05 * torch.abs(torch.atan2(pole_pos, cart_pos))
    rew_pole_angle_diff = -0.02 * torch.abs(pole_vel - self.step_dt * pole_pos * 9.81 / cart_pos)
    rewards = {
        "alive": rew_alive,
        ...
        "pole_angle_diff": rew_pole_angle_diff,
    }
