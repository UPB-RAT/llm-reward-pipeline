def _get_rewards(self) -> torch.Tensor:
    ...
    rew_smoothness = -0.01 * torch.abs(pole_vel)  # Novel: Penalize high angular velocity
    rew_cart_position = -0.005 * torch.abs(cart_pos)  # Novel: Penalize cart displacement
