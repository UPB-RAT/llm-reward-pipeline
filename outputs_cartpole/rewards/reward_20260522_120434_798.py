def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_balance = -torch.abs(pole_pos)  # Novel component: penalize pole position
    rew_cart_position = -torch.exp(-torch.abs(cart_pos))  # Novel component: reward for cart staying near center
    rewards = {
        "alive": rew_alive,
