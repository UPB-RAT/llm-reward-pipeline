def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_pos = rew_scale_cart_vel * torch.abs(cart_pos)
    rew_pole_pos_smooth = rew_scale_pole_pos * torch.exp(-torch.abs(pole_pos) * 5.0)
    rewards = {
        "alive": rew_alive,
        ...
        "pole_pos_smooth": rew_pole_pos_smooth,
    }
