def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_balance = torch.exp(-torch.abs(pole_pos * 10.0))  # Novel component: penalize out-of-balance pole positions
    rew_cart_stability = torch.exp(-torch.abs(cart_pos * 2.0))  # Novel component: penalize out-of-center cart positions
    rewards = {
        "alive": rew_alive,
        ...
        "cart_stability": rew_cart_stability,
    }
