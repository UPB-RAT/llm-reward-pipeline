def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_pos = rew_scale_pole_pos * torch.abs(cart_pos)  # Novel component
    rew_pole_acc = rew_scale_pole_vel * torch.abs(self.joint_acc[:, self._pole_dof_idx[0]])  # Novel component
