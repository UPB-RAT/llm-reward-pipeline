def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_pos = rew_scale_pole_pos * torch.abs(cart_pos)  # Novel component: Penalize cart position
    rew_pole_angle = rew_scale_pole_vel * torch.abs(pole_pos)  # Novel component: Penalize pole angle
    rewards = {
        "alive": rew_alive,
