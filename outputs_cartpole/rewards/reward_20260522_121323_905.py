def _get_rewards(self) -> torch.Tensor:
    ...
    rew_cart_angle = rew_scale_pole_pos * torch.square(torch.atan2(pole_pos, cart_pos))
    rew_pole_smoothness = rew_scale_pole_vel * torch.exp(-torch.square(pole_vel))
    rewards = {
        "alive": rew_alive,
        ...
        "pole_smoothness": rew_pole_smoothness,
    }
