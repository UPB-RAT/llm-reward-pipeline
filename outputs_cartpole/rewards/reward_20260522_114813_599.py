def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_angle = -torch.cos(pole_pos)  # Novel component: penalize deviation from vertical
    rew_cart_balance = -torch.abs(cart_pos)  # Novel component: penalize cart displacement from center
