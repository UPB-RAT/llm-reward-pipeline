def _get_rewards(self) -> torch.Tensor:
    ...
    rew_pole_balance = rew_scale_pole_pos * torch.exp(-torch.square(pole_pos))
    rew_cart_smooth = rew_scale_cart_vel * torch.exp(-torch.square(cart_vel))
    rew_pole_damp = rew_scale_pole_vel * torch.exp(-torch.square(pole_vel))
    ...
    rewards = {
        ...
        "pole_balance": rew_pole_balance,
        "cart_smooth": rew_cart_smooth,
        "pole_damp": rew_pole_damp,
    }
