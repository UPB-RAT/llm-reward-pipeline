def _get_rewards(self) -> torch.Tensor:
    ...
    lin_vel_mapped = 1 - torch.tanh(lin_vel / 1.5)
    ang_vel_mapped = 1 - torch.tanh(ang_vel / 0.75)
    height_mapped = 1 - torch.tanh(height - 1.0)
    orientation_mapped = 1 - torch.tanh(orientation / 0.5)
