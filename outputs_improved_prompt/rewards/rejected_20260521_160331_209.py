def _get_rewards(self) -> torch.Tensor:
    ...
    velocity_smoothness_reward_scale = -0.01
    ...
    velocity_smoothness = torch.sum(torch.abs(self._robot.data.root_lin_vel_b[:, :2]), dim=1)
    ...
    rewards = {
        ...
        "velocity_smoothness": velocity_smoothness * velocity_smoothness_reward_scale * self.step_dt,
    }
