def _get_rewards(self) -> torch.Tensor:
    ...
    height_error = torch.abs(height - self.desired_pos_w[:, 2]) / self.cfg.distance_to_goal_reward_scale
    orientation_error = orientation * orientation_reward_scale * self.step_dt
