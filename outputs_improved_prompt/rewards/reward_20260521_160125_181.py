def _get_rewards(self) -> torch.Tensor:
    ...
    height_reward = torch.exp(-height_error * height_reward_scale)
    ...
    rewards = {
        ...
        "tilt": torch.sum(torch.square(self._robot.data.projected_gravity_b[:, :2]), dim=1) * tilt_reward_scale * self.step_dt,
        "height": height_reward * height_reward_scale,
    }
