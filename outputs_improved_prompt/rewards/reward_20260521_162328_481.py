def _get_rewards(self) -> torch.Tensor:
    ...
    energy_consumption_reward_scale = -0.001
    ...
    energy_consumption = torch.sum(torch.square(self._robot.data.root_lin_vel_b + self._robot.data.root_ang_vel_b), dim=1)
    ...
    rewards = {
        ...
        "height": height_reward_scale * height * self.step_dt,
        "tilt": tilt * tilt_reward_scale * self.step_dt,
        "energy_consumption": energy_consumption * energy_consumption_reward_scale * self.step_dt,
    }
