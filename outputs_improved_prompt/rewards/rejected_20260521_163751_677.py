def _get_rewards(self) -> torch.Tensor:
    ...
    angular_consistency_reward_scale = -0.02
    ...
    angular_consistency = torch.sum(torch.abs(self._robot.data.root_ang_vel_b[:, 0] - self._robot.data.root_ang_vel_b[:, 1]), dim=1)

    # Collect rewards into a dictionary
    rewards = {
        ...
        "angular_consistency": angular_consistency * angular_consistency_reward_scale * self.step_dt,
    }
