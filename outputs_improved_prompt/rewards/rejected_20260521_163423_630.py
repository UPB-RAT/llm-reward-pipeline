def _get_rewards(self) -> torch.Tensor:
    ...
    angular_velocity_penalty_scale = -0.02
    ...
    angular_velocity_penalty = torch.sum(torch.square(self._robot.data.root_ang_vel_b[:, 2]), dim=1)
    ...
    rewards = {
        ...
        "angular_velocity_penalty": angular_velocity_penalty * angular_velocity_penalty_scale * self.step_dt,
    }
