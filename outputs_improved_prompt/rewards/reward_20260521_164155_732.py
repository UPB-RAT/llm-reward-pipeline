def _get_rewards(self) -> torch.Tensor:
    ...
    angular_balance_reward_scale = -0.005
    ...
    angular_balance = torch.abs(self._robot.data.root_ang_vel_b[:, 2])
    ...
    rewards = {
        ...
        "angular_balance": angular_balance * angular_balance_reward_scale * self.step_dt,
    }
