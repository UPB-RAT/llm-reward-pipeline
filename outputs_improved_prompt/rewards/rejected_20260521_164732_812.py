def _get_rewards(self) -> torch.Tensor:
    ...
    height_diff = self._robot.data.root_pos_w[:, 2] - self.desired_pos_w[:, 2]
    ...
    rewards = {
        ...
        "height_diff": height_diff * height_reward_scale * self.step_dt,
        "orientation_error": orientation_error * orientation_reward_scale * self.step_dt,
    }
