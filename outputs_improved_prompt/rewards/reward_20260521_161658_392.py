def _get_rewards(self) -> torch.Tensor:
    ...
    orientation_error_reward_scale = -0.01
    ...
    velocity_error = torch.sum(torch.square(self._desired_pos_w - self._robot.data.root_pos_w), dim=1)
    ...
    rewards = {
        ...
        "orientation_error": orientation_error * orientation_error_reward_scale * self.step_dt,
    }
