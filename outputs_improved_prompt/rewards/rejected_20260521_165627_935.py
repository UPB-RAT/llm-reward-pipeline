def _get_rewards(self) -> torch.Tensor:
    ...
    lin_vel_mapped = 1 - torch.tanh(lin_vel / 0.2)
    ang_vel_mapped = 1 - torch.tanh(ang_vel / 0.2)
    height_mapped = 1 - torch.tanh(height / 5.0)
    orientation_mapped = 1 - torch.tanh(orientation / 1.0)
