def _get_rewards(self) -> torch.Tensor:
    ...
    lin_vel_smoothness = torch.sum(torch.square(self._robot.data.root_lin_vel_b[:, 0]), dim=1)
    ...
    rewards = {
        ...
        "lin_vel_smoothness": lin_vel_smoothness * lin_vel_reward_scale * self.step_dt,
    }
