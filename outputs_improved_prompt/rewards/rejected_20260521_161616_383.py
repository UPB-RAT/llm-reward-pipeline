def _get_rewards(self) -> torch.Tensor:
    ...
    smoothness = torch.sum(torch.abs(self._robot.data.root_lin_vel_b[:, 1] - self._robot.data.root_ang_vel_b[:, 1]), dim=1)
    ...
    rewards = {
        ...
        "smoothness": smoothness * smoothness_reward_scale * self.step_dt,
