def _get_rewards(self) -> torch.Tensor:
    ...
    stability = torch.exp(-torch.sum(torch.square(self._robot.data.root_ang_vel_b), dim=1))
    ...
    rewards = {
        ...
        "stability": stability * stability_reward_scale * self.step_dt,
    }
