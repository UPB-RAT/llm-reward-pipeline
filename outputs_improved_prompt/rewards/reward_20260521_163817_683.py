def _get_rewards(self) -> torch.Tensor:
    ...
    angular_momentum_reward_scale = -0.02
    ...
    angular_momentum = torch.sum(torch.square(self._robot.data.root_ang_vel_b), dim=1)
    ...
    rewards = {
        ...
        "angular_momentum": angular_momentum * angular_momentum_reward_scale * self.step_dt,
    }
