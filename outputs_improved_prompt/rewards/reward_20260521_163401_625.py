def _get_rewards(self) -> torch.Tensor:
    ...
    heading_error = torch.atan2(self._desired_pos_w[:, 2] - height, self._desired_pos_w[:, 0] - self._robot.data.root_pos_w[:, 0])
    ...
    rewards = {
        ...
        "heading": heading_error * heading_reward_scale * self.step_dt,
    }
